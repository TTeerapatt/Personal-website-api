-- 010_contact_me_menu.sql
-- Seed Contact Me admin menu tab (view/edit) under Content + owner grants
...
FROM (
  VALUES
    ('content', 'contact-me', 'Contact Me', 6)
...
SET sort_order = CASE code
  ...
  WHEN 'contact-me' THEN 6
  WHEN 'site-settings' THEN 7
  ELSE sort_order
END,
updated_at = NOW()
